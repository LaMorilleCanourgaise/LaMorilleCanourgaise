...
chatbot.innerHTML = `
  <button class="chatbot-toggle" type="button" aria-label="Ouvrir l'assistant" aria-expanded="false">
    <img src="logos/logo-la-morille-canourguaise.png" alt="La Morille Canourgaise">
  </button>
  <section class="chatbot-window" hidden aria-label="Assistant La Morille Canourgaise">
    <header class="chatbot-header">
      <img src="logos/logo-la-morille-canourguaise.png" alt="La Morille Canourgaise">
      <div><strong>La Morille Canourgaise</strong><span><i></i> Assistant en ligne</span></div>
      <button class="chatbot-close" type="button" aria-label="Fermer">×</button>
    </header>
    <div class="chatbot-body">
      <div class="chatbot-message">Bonjour et bienvenue chez La Morille Canourgaise.<br>
        <img class="chatbot-welcome-logo" src="logos/logo-la-morille-canourguaise.png" alt="La Morille Canourgaise"><br>
        Je suis l'assistant du site. Je peux vous renseigner sur nos morilles, les arrivages, votre commande ou vous orienter vers la bonne page.<br><br>
        Comment puis-je vous aider ?
      </div>
      <div class="chatbot-suggestions">
        <button type="button" data-chat-question="Comment se déroule une commande ?">Comment se déroule une commande ?</button>
        <button type="button" data-chat-question="Quand les morilles sont-elles disponibles ?">Quand les morilles sont-elles disponibles ?</button>
        <button type="button" data-chat-question="Je veux découvrir les morilles">Découvrir les morilles</button>
        <button type="button" data-chat-question="Nous contacter">Nous contacter</button>
      </div>
      <div class="chatbot-conversation" aria-live="polite"></div>
    </div>
    <form class="chatbot-form">
      <input name="question" type="text" placeholder="Posez votre question..." autocomplete="off">
